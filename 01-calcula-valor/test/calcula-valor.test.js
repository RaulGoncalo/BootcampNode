...
// describe("Trabalho pratico - calcularPrestacoes parâmetros inválidos", () => {
//   test('Numero de prestações como NaN', () => {
//     debugger;
//     const numeroPrestacoes = 'abej';
//     const montante = 35;

//     const prestacoes = calculaValor.calcularPrestacoes(montante, numeroPrestacoes);

//     expect(prestacoes).toStrictEqual([''])
//   })

//   test('Montate menor igual a zero', () => {
//     debugger;
//     const numeroPrestacoes = 3;
//     const montante = 0;
